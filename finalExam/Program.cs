...
foreach (string name in studentNames)
{
    ...
    */
    ...
    examScore = examScore / (decimal)examAssignments;
    extraCreditScore = extraCreditScore / gradedAssignments;
    extraCreditPoints = ( (decimal)(extraCreditScore + examScore) / examAssignments / 10);
